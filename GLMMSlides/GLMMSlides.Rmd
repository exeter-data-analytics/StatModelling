...
So it's giving the correct result for a different model, and ultimately not the model we want.

It's also not always possible to average across individuals in this way.
