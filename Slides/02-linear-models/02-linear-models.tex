...
\includegraphics<2|handout:2>[width=.65\textwidth]{example2.pdf}
\includegraphics<3|handout:3>[width=.65\textwidth]{example3.pdf}
\includegraphics<4|handout:4>[width=.65\textwidth]{example4.pdf}
\end{figure}
